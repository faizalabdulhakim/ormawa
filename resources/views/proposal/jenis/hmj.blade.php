  ...
  <div class="content">
    ...
    <table>
      <tr>
        <td style="width: 50%;">
          <div class="signature">
            Ketua {{ $proposal->proker->ormawa->nama }},<br>
            <br>
            <br>
            <br>
            <span class="nama">{{ $proposal->proker->ormawa->ketua->nama }}</span><br>
            <span class="nim">{{ $proposal->proker->ormawa->ketua->nim }}</span><br>
          </div>
        </td>
        <td style="width: 50%;">
          <div class="signature">
      ...
      <tr>
        <td style="width: 50%;">
          <div class="signature">
            Ketua Jurusan <br> {{ $proposal->proker->ormawa->jurusan }},<br>
            <br>
            <br>
            <br>
            <span class="nama">{{ $proposal->ketua_jurusan }}</span><br>
            <span class="nim">{{ $proposal->nip_ketua_jurusan }}</span><br>
          </div>
        </td>
        <td style="width: 50%;">
          <div class="signature">
            Pembina Mahasiswa Jurusan <br> {{ $proposal->proker->ormawa->jurusan }},<br>
            <br>
            <br>
            <br>
            <span class="nama">{{ $proposal->proker->ormawa->pembina->nama }}</span><br>
            <span class="nim">{{ $proposal->proker->ormawa->pembina->nim }}</span><br>
          </div>
        </td>
      </tr>
      <br>
