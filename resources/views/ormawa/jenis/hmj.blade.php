  ...
  <div class="content">
    ...
    <table>
      ...
      <tr>
        <td style="width: 50%;">
          <div class="signature">
            Ketua Jurusan <br> {{ $ormawa->jurusan }},<br>
            <br>
            <br>
            <br>
            <span class="nama">{{ $ormawa->ketua_jurusan }}</span><br>
            <span class="nim">{{ $ormawa->nip_ketua_jurusan }}</span><br>
          </div>
        </td>
        <td style="width: 50%;">
          <div class="signature">
            Pembina Mahasiswa Jurusan <br> {{ $ormawa->jurusan }},<br>
            <br>
            <br>
            <br>
